...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="57">
    ...
    <section class="content" id="sec_editar_item">
        <div class="container-fluid">
            ...
            <div class="row align-items-center mb-3 text-center item<?php echo $id_item; ?>" id="div_id_item<?php echo $id_item; ?>">
                <div class="col text-center">
                    <div class="input-group">
                        ...
                        <a href="#stay" onclick="excluirItem(this)" data-item="<?php echo $id_item; ?>" class="input-group-text" title="Excluir Item"><i class="fa fa-trash text-danger"></i></a>
                    </div>
                    <div class="container collapse" id="div_sucesso_editar_item_id_item<?php echo $id_item; ?>"></div>
                </div>
            </div>
            <div class="row align-items-center mb-3 item<?php echo $id_item; ?>">
                <div class="col text-center">
                    ...
                    <div class="input-group">
                        ...
                        <a href="#stay" onclick="alterarImagemItem(this)" data-item="<?php echo $id_item; ?>" class="input-group-text" title="Alterar Imagem do Item"><i class="fa fa-eraser text-warning"></i></a>
                    </div>
            ...
            <div class="row align-items-center mb-3 item<?php echo $id_item; ?>">
                <div class="col text-center">
                    <div class="input-group">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="txt_nome_item<?php echo $id_item; ?>" id="txt_nome_item<?php echo $id_item; ?>" value="<?php echo $nome_item; ?>" />
                            <label for="txt_nome_item<?php echo $id_item; ?>">Nome</label>
                        </div>
                        <a href="#stay" onclick="alterarNomeItem(this)" data-item="<?php echo $id_item; ?>" class="input-group-text" title="Alterar Nome do Item"><i class="fa fa-eraser text-warning"></i></a>
                    </div>
                    <div class="container collapse" id="div_sucesso_editar_item_nome<?php echo $id_item; ?>"></div>
                </div>
            </div>
            <div class="row align-items-center mb-3 item<?php echo $id_item; ?>">
                <div class="col text-center">
                    <div class="input-group">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="txt_descricao_item<?php echo $id_item; ?>" id="txt_descricao_item<?php echo $id_item; ?>" value="<?php echo $descricao_item; ?>" />
                            <label for="txt_descricao_item<?php echo $id_item; ?>">Descrição</label>
                        </div>
                        <a href="#stay" onclick="alterarDescricaoItem(this)" data-item="<?php echo $id_item; ?>" class="input-group-text" title="Alterar Descrição do Item"><i class="fa fa-eraser text-warning"></i></a>
                    </div>
                    <div class="container collapse" id="div_sucesso_editar_item_descricao<?php echo $id_item; ?>"></div>
                </div>
            </div>
            <?php } ?>
